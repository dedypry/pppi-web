...
export default function LandingLayout({ children }: IChild) {
    return (
        <>
            <div className="container mx-auto flex justify-between bg-black px-8 pt-2 text-sm text-white">
            ...
            <Navbar maxWidth="full" className="bg-transparent bg-gradient-to-b from-black to-transparent" isBlurred={false} isBordered={false}>
                <NavbarBrand>
